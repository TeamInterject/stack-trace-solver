...
from stack_exchange import get_stackoverflow_links

input_stack_trace = '''javax.servlet.ServletException: Something bad happened
...
result = get_stackoverflow_links(exceptions.__repr__())
